    ...
    <section className="section section-dark2" ref={ref}>
      <div className="container">
        <div className="sec-head reveal">
          ...
          <h2 className="sec-title">Our <span className="sec-accent">Process</span></h2>
          <p className="sec-sub">A proven framework that turns your vision into measurable results — from brief to launch and beyond.</p>
