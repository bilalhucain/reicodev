...
export const PROJECTS: ProjectCard[] = [
  ...
  },
  {
    ...
    title:         'Marham Pharmacy',
    category:      'seo',
    categoryLabel: 'SEO • Healthcare',
    industry:      'Healthcare & Pharmacy',
    location:      'Pakistan',
    description:   'Local SEO and WooCommerce optimisation for a medical store — improved search visibility across multiple product categories.',
    liveUrl:       'https://www.marhampharmacy.pk',
    hasDetailPage: false,
